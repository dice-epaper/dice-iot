// This is for small Display format !!
...
void setup() { 
  ...
  showFont("[Dole] 바나나 2송이 250g", u8g2_font_unifont_t_korean1, 10, 20);
  showFont("100g당 3200원", u8g2_font_unifont_t_korean1, 10, 40);
  showfreeFont("8,500",&FreeSansBold18pt7b,90,80,GxEPD_RED);
  display.update();   
...
void showBitmap(const char image[], const int num1, const int num2, const int num3, const int num4 )
{
  ...
  if(image == "sale_super"){
    display.setRotation(0);
    display.drawExampleBitmap(sale_super, num1, num2, num3, num4, GxEPD_RED);//10, 10, 40, 40,
  }
  else if(image == "sale_magam"){
    display.setRotation(0);
    display.drawExampleBitmap(sale_magam, num1, num2, num3, num4, GxEPD_RED);//10, 10, 40, 40,
  }
  else if(image == "sale_1plus1"){
    display.setRotation(0);
    display.drawExampleBitmap(sale_1plus1, num1, num2, num3, num4, GxEPD_RED);//10, 10, 40, 40,
  }
  else if(image == "sale_2plus1"){
    display.setRotation(0);
    display.drawExampleBitmap(sale_2plus1, num1, num2, num3, num4, GxEPD_RED);//10, 10, 40, 40,
  }
  delay(500);
}
