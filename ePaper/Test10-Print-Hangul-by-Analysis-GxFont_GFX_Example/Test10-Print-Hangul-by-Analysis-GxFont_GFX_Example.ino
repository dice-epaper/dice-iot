...
void loop()
{
  ...
  showFont("u8g2_font_helvR14_tf", u8g2_font_unifont_t_korean1);// u8g2_font_helvR14_tf); // select u8g2 font from here: https://github.com/olikraus/u8g2/wiki/fntlistall
  delay(2000);
