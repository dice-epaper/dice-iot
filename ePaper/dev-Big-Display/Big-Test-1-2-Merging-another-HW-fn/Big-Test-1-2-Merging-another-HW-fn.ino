...
#include <GxIO/GxIO.h>
#if defined(ESP8266)
GxIO_Class io(SPI, /*CS=*/ 15, /*DC=*/ 10, /*RST=*/ 0); // arbitrary selection of D3(=0), D4(=2), selected for default of GxEPD_Class
GxEPD_Class display(io, /*RST=*/ 0, /*BUSY=*/ 4); // default selection of D4(=2), D2(=4)
#endif
...
SoftwareSerial mySoftwareSerial(16, 5); 
